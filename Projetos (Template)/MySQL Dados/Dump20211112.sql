...
--
-- Dumping events for database 'A1'
--
...
-- Dump completed on 2021-11-12 23:03:48
-- MySQL dump 10.13  Distrib 8.0.25, for macos11 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-09-22 02:56:53',NULL),('diagnostics.include_raw','OFF','2021-09-22 02:56:53',NULL),('ps_thread_trx_info.max_length','65535','2021-09-22 02:56:53',NULL),('statement_performance_analyzer.limit','100','2021-09-22 02:56:53',NULL),('statement_performance_analyzer.view',NULL,'2021-09-22 02:56:53',NULL),('statement_truncate_len','64','2021-09-22 02:56:53',NULL);
...
INSERT INTO `fornecedores` VALUES (1,'MARCELO ','RUA 2','CENTRO 2','UBÃ 2','MG','234','234234');
...
INSERT INTO `produtos` VALUES (1,1,'pele de boi',100,45),(2,1,'cola branca',56,100);
...
INSERT INTO `tbl_usuarios` VALUES (1,'Administrador','admin','123'),(2,'Sthefany Schroeder','Sthefany','2004'),(3,'Gabriel Girardi','Gabriel','1001');
...
INSERT INTO `vendas_produto` VALUES (1,1,1,3),(2,2,1,2);
/*!40000 ALTER TABLE `vendas_produto` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'sisvendas'
--

--
-- Dumping routines for database 'sisvendas'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2021-11-12 23:03:49
-- MySQL dump 10.13  Distrib 8.0.25, for macos11 (x86_64)
--
-- Host: localhost    Database: SalesOrdersExample
-- ------------------------------------------------------
-- Server version	5.7.13
...
--
-- Dumping events for database 'SalesOrdersExample'
--

--
-- Dumping routines for database 'SalesOrdersExample'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
INSERT INTO `tbl_usuario` VALUES (1,'Administrador','admin','admin'),(2,'Gabriel Girardi','Biel','1001');
...
INSERT INTO `tbl_venda` VALUES (21,1,'2021-11-12',108,113,5),(22,1,'2021-11-12',93,98,5),(23,1,'2021-11-12',209.99000549316406,225,15.010000228881836),(24,1,'2021-11-12',132,142,10);
...
INSERT INTO `tbl_vendas_produtos` VALUES (37,69,21,40,1),(38,69,21,40,1),(39,71,21,20,1),(40,10,21,13,1),(41,10,22,13,1),(42,11,22,25,1),(43,11,22,25,1),(44,32,22,35,1),(45,35,23,45,5),(46,73,24,25,1),(47,77,24,39,3);
/*!40000 ALTER TABLE `tbl_vendas_produtos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'dbwsvendas'
--

--
-- Dumping routines for database 'dbwsvendas'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
